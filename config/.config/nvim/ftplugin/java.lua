...
-- local config_dir = vim.fn.stdpath('data') .. '/site/java/config/' .. project_name
...
local config = {
    ...
    settings = {
        java = {
            home = "/home/emile/.sdkman/candidates/java/current",
            eclipse = {
            ...
            format = {
                ...
                settings = {
                    url = root_dir .. "/config/eclipse-formatter.xml",
                    --   profile = "GoogleStyle",
                },
            },
            completion = {
